...
* For the labs, feel free to set `eval=TRUE` for the existing R chunks. This will make the documents longer, but will allow you to see everything in the generated HTML or PDF file.

* LaTeX on Mac (Miktex). This is a big download and some are having issues installing it. First, try downloading with Safari. If yoar are still having issues, you can create PDFs from the HTML pages using the print dialog.

* Please try to download the GoToMeeting application before your meetup presentation.

## Meetup Presentations

1. James Topor (2.7)
2. Dan Brooks (2.26)
3. Dan Smilowitz (2.29)
