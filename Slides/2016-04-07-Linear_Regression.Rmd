...
* All project proposals have been graded.
* In general, I recommend doing a regression analysis, but there were a couple where I recommended doing an ANOVA.
* When doing the exploratory analysis (drawn primarily from the descriptive statistics section in the proposal), be sure to include appropriate visualizations.
* Be careful about using causal statements in your research question. If your data is observsation, you cannot make causal claims.
