...
* When submitting labs, please submit both a `Rmd` file and a `PDF` file. The arrow to the right of the `Knit HTML` button will allow you to change the output format. If that doesn't work, you can Knit to HTML the create a PDF from your browser.

* Please sign-up for your presentation week ASAP!
...
1. Chris Martin https://youtu.be/boZYP1mFUDw
