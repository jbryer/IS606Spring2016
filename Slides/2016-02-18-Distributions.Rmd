...
* Grades for Chapter 1 homework and Lab 0 are done. It appears you are not notified when comments are posted, so please be sure to check for them on Blackboard.

* If you wish to receive an email when someone posts in the forums, you have to subscribe (you are not  automatically)
